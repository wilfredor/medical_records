...
function applyDropShadows(cssSelector,shadowStyle){
	if(document.getElementsByTagName && document.createElement){
		...
		for(i=0;i<elements.length;i++){
			...
			wrap2.className = "topleft";
			wrap3.className = "topright";
			wrap4.className = "bottomleft";
			wrap5.className = "bottomright";
			
			// duplicate the image to be shadowed
			var newElement = element.cloneNode(true);
			
			// nest the new image and wrapper divs
			wrap1.appendChild(newElement);
			wrap1.appendChild(wrap2);
			wrap1.appendChild(wrap3);
			wrap1.appendChild(wrap4);
			wrap1.appendChild(wrap5);
